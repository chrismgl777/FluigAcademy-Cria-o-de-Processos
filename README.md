...
Criando esse repositório para indexar meu treinamento, afim de auxiliar iniciantes na área.


Primeiro passo, criando um projeto no Eclipse Luna.

Com o Eclipse aberto, esta é a imagem inicial:
